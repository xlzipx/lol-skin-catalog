...
- **The champion roster is now clickable.** Selecting a champion jumps straight
  to the page where their skins begin. All 121 links on a test account were
  verified to land on the right page.
- **Fixed the contents plaques on the cover**, which were wide enough to run
  into the ornamental frame. They are now a fixed width and centred.
...
```
SHA256  0C2C27D719495070D54C2D2C09FFB3A39CB54DC8310DD94908A784A9A7AC1824  LoL-Skin-Catalog.zip
```
